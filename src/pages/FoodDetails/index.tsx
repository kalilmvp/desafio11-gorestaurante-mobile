...
const FoodDetails: React.FC = () => {
  ...
  useEffect(() => {
    async function loadFood(): Promise<void> {
      ...
      const foodMapped = Object.assign(response.data, {
      ...
      const responseFavorite = await api.get(`favorites/${foodMapped.id}`);
      setIsFavorite(!!responseFavorite.data.id);
    }
  ...
  const cartTotal = useMemo(() => {
    ...
    return formatValue(foodTotal + totalExtras);
